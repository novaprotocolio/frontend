...
// import 'sdk-charts/src/style.scss';
...
class Charts extends React.Component {
  ...
  render() {
    ...
    const { baseToken, quoteToken } = this.props.currentMarket;
    return (
      <>
        ...
        <div className="flex-column flex-1 ">
          <div className="grid flex-2" ref={this.tradeChartWrapper}>
            <TradeChart
              theme="light"
              data={this.state.data.length > 10 ? this.state.data : require('./constants').testData}
              priceDecimals={5}
